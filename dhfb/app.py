...
def _get(path):
    ...
    No file is locally stored. If the file doesn't exist
    (NoSuchKey) then this falls back to listing objects
    from namespace/dir.
    ...
    def generate_file(result):
        def read_chunk():
            return result['Body'].read(int(app.config['CHUNK_SIZE']))
